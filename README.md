...
| [Social](https://github.com/gusmanwidodo/auth-kit-social) | `gusmanwidodo/auth-kit-social` | `/auth-kit/social/{provider}/{redirect,callback,link,unlink}` | OAuth / social login as a thin wrapper over Laravel Socialite. Multi-provider linked identities, encrypted tokens, login hooks |
